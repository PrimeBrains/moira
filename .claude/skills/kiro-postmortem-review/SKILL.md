...
**Mission**: 蓄積された**両台帳**の要因分析から、横展開可能な学習 (Try) を抽出し steering 化する。
...
- Read `.kiro/postmortem/defects.md` (障害台帳の全体)
- Read `.kiro/analysis/INDEX.md` と `.kiro/analysis/entries/*.md` (**非障害台帳**)
- Read `.kiro/steering/moira-change-analysis.md` (項目定義・出所ラベル・トリガの規範)
- Read `.claude/skills/kiro-postmortem-add/rules/taxonomy-reference.md` (**有効ラベル定義の正本**)
